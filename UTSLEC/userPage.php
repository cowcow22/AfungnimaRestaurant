...
<body>
    <div class="bg-white">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    ...
                    <div style="display: flex; flex-direction:column">
                        <a href="#sectionKategori" class="mt-6 text-lg leading-8 text-gray-600"><span></span>Scroll Down</a>
                        <!-- <a href="#sectionKategori" class="mt-6 text-lg leading-8 text-gray-600"><span></span>V</a> -->
                    </div>
                </div>
            </div>
        ...
        <section id="sectionKategori" class="bg-gray-100">
